# Introducing [Astro Micro 🔬](https://giftiem.github.io/)
...
Micro adds features like [Pagefind](https://pagefind.app) for search, [Giscus](https://giscus.app) for comments, and more. For a full list of changes, see this [blog post](https://giftiem.github.io/blog/00-micro-changelog).
